...
def main():
    ...
    # Import tab modules
    from src.app.tabs.themes_tab import render_themes_tab
    from src.app.tabs.platforms_tab import render_platforms_tab
    from src.app.tabs.analyze_tab import render_analyze_tab
    from src.app.tabs.topics_tab import render_topics_tab
    from src.app.tabs.briefs_tab import render_briefs_tab
    from src.app.tabs.draft_tab import render_draft_tab
    from src.app.tabs.polish_tab import render_polish_tab
    from src.app.tabs.export_tab import render_export_tab
